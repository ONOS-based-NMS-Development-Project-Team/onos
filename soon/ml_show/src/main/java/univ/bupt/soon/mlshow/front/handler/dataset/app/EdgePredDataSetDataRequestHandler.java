...
import static univ.bupt.soon.mlshow.front.Utils.ANNOTS;
import static univ.bupt.soon.mlshow.front.Utils.ASC;

/**
 * #soonEvent: edgePredDataSetDataRequest
 * {
 * 	"event":"edgePredDataSetDataRequest",
 * 	"payload":{
 * 		"firstCol":"dataId",
 * 		"firstDir":"asc",
 * 		"secondCol":"edgeId",
 ...
 *                }    * 	}
 * }
 * #soonEvent: edgePredDataSetDataResponse
 * {
 * 	"event":"edgePredDataSetDataResponse",
 * 	"payload":{
 * 		"edgePredDataSets":[{
 * 			"dataId":"",
 * 			"edgeId":"",
 ...
 * }
 */
public class EdgePredDataSetDataRequestHandler extends TableRequestHandler {
    private static final String DATA_REQ = "edgePredDataSetDataRequest";
    private static final String DATA_RESP = "edgePredDataSetDataResponse";
    private static final String TABLES = "edgePredDataSets";
    ...
    public EdgePredDataSetDataRequestHandler() {
    ...
    protected String[] getColumnIds() {
        String[] COLUMN_IDS = {DATA_ID, EDGE_ID, DATASET_TYPE, TIMEPOINT, DATASET_ID, ONE_HOUR_AFTER, TWO_HOURS_BEFORE};
        return COLUMN_IDS;
    }
...
//        if (service.getAppStatics().getTrainDataset().containsKey(datasetId)) {
            String sql = "SELECT * FROM edge_load OFFSET "+offset+" LIMIT "+limit+";";
            List<Item> results = service.updateData(sql, EdgePredictionItem.class);
            for (Item it : results) {
                EdgePredictionItem item = (EdgePredictionItem) it;
//                DATA_ID, EDGE_ID, DATASET_TYPE, TIMEPOINT, DATASET_ID, ONE_HOUR_AFTER, TWO_HOURS_BEFORE
                tableModel.addRow()
